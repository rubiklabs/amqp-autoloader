...
var Server = /** @class */ (function () {
    function Server(options) {
        ...
        this.connectionString = "amqp://".concat(options.amqp.user, ":").concat(options.amqp.password, "@").concat(options.amqp.host, "/").concat(options.amqp.vhost);
    ...
    Server.prototype.createConnection = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, amqplib_1.default.connect(this.connectionString)];
